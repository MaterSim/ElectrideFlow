# ElectrideFlow - High-Throughput Inorganic Electride Discovery Workflow Accelerated by Generative Models and Hierarchical Prescreening

A four-stage intelligent workflow for high-throughput inorganic electride discovery on HPC clusters:

1. **Chemical Exploration** - Generative AI models (MatterGen) explore composition space targeting electride-favorable chemistries
2. **Stability Screening** - MatterSim (MLP) pre-screening filters structures by energy above hull before expensive DFT calculations
3. **Electride Identification** - Coarse DFT relaxation with ELF & PARCHG topological analysis to identify electride candidates
4. **Refinement** - Tight DFT relaxation with refined convex hull analysis for final candidate validation
 ...
 **HPC-friendly** - workflow manager runs as SLURM job
...
### Parallel Pre-screening Results Missing
...
**Credits**:
- This implementation by Shuo Tao ([@Tack-Tau](https://github.com/Tack-Tau))
- Supervised by Prof. Qiang Zhu ([@qzhu2017](https://github.com/qzhu2017))

**Tools & Libraries**:
- [Pymatgen](https://pymatgen.org/) - VASP input generation & MP API
- [PyXtal](https://github.com/MaterSim/PyXtal) - Crystal structure analysis
...
- [Phonopy](https://phonopy.github.io/phonopy/) - Phonon band calculation (optional)
- [Materials Project](https://next-gen.materialsproject.org/) - Competing phase data

**Key Paper**:
```bibtex
@article{zhuComputationalDiscoveryInorganic2019,
  title = {Computational {{Discovery}} of {{Inorganic Electrides}} from an {{Automated Screening}}},
  author = {Zhu, Qiang and Frolov, Timofey and Choudhary, Kamal},
  year = 2019,
  month = nov,
  journal = {Matter},
  volume = {1},
